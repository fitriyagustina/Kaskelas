...
class PembayaranController extends Controller
{
    ...
    public function index()
    {
        $pembayaran = Pembayaran::with('siswa')
            ->select('siswa_id', \Illuminate\Support\Facades\DB::raw('MAX(id) as id'), \Illuminate\Support\Facades\DB::raw('MAX(tgl_pembayaran) as tgl_bayar_last'), \Illuminate\Support\Facades\DB::raw('SUM(jumlah_bayar) as total_bayar'))
            ->groupBy('siswa_id')
